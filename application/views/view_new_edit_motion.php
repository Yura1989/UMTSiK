...
<nav class="navbar navbar-expand navbar-dark bg-primary">
    <a class="navbar-brand" href="#">Информации о движении МТР на базе (новая форма)</a>
    <div>
    <?php
                ...
                <div class="card mb-4">
                    ...
                    <table class="motion_table table compact table-bordered table-hover table-sm" style="width:100%">
                        ...
                        <tr class="text-center" style="font-size: 8pt;" >
                            ...
                            >Массогабаритные характеристики***</th>
                        ...
                        if ( (($value['id_bond_order_mtr']) == ($item['id_order'])) && ($value['reference'] == 2) ) { ?>
                        <tr>
                            <td><input style="font-size: 9pt;" name="length_motion[]" type="text" class="length_motion_2 form-control input-block" disabled value="<?php if(isset($value['length_motion'])) echo($value['length_motion']); ?>">
                            </td>
                            <td><input style="font-size: 9pt;" name="width_motion[]" type="text" class="width_motion_2 form-control input-block" disabled value="<?php if(isset($value['width_motion'])) echo($value['width_motion']); ?>"></td>
                            <td><input style="font-size: 9pt;" name="height_motion[]" type="text" class="height_motion_2 form-control input-block" disabled value="<?php if(isset($value['height_motion'])) echo($value['height_motion']); ?>"></td>
                            <td><input style="font-size: 9pt;" name="weight_motion[]" type="text" class="weight_motion_2 form-control input-block" disabled value="<?php if(isset($value['weight_motion'])) echo($value['weight_motion']); ?>"></td>
                            <td><input style="font-size: 9pt;" name="total_motion[]" type="text" class="total_motion_2 form-control input-block" disabled value="<?php if(isset($value['total_motion'])) echo($value['total_motion']); ?>"></td>
                            <td><input style="font-size: 9pt;" name="dateRequest_motion[]" type="text" class="dateRequest_motion_2 form-control date_order_id" autocomplete="off" disabled value="<?php if($value['dateRequest_motion'] == NULL || $value['dateRequest_motion'] == '0000-00-00' || $value['dateRequest_motion'] == '1970-01-01') { echo('-');  } else { echo(date('d-m-Y', strtotime($value['dateRequest_motion']))); }?>"></td>
                            <td><input style="font-size: 9pt;" name="infoShipments_motion[]" type="text" class="infoShipments_motion_2 form-control input-block" disabled value="<?php if(isset($value['infoShipments_motion'])) echo($value['infoShipments_motion']); ?>"></td>
                            <td><input style="font-size: 9pt;" name="dateShipments_motion[]" type="text" class="dateShipments_motion_2 form-control date_order_id" autocomplete="off" disabled value="<?php if($value['dateShipments_motion'] == NULL || $value['dateShipments_motion'] == '1970-01-01' || $value['dateShipments_motion'] == '0000-00-00') { echo('-');  } else { echo(date('d-m-Y', strtotime($value['dateShipments_motion']))); }?>"></td>
                            <td><input style="font-size: 9pt;" name="cargo_motion[]" type="text" class="cargo_motion_2 form-control input-block" disabled
                            ...
                            <td><input style="font-size: 9pt;" name="tranzit_motion[]" type="text" class="tranzit_motion_2 form-control input-block" disabled value="<?php if(isset($value['tranzit_motion'])) echo($value['tranzit_motion']); ?>"></td>
                            <td><input style="font-size: 9pt;" name="shipped_motion[]" type="text" class="shipped_motion_2 form-control input-block" data-class_mtr="<?php if(isset($value['codeMTR'])) echo($value['codeMTR']); ?>" disabled value="<?php if(isset($value['shipped_motion'])) echo($value['shipped_motion']); ?>"></td>
                            <td><input style="font-size: 9pt;" name="remains_motion[]" type="text" class="remains_motion_2 form-control input-block" disabled value="<?php if(isset($value['remains_motion'])) echo($value['remains_motion']); ?>"></td>
                            <td><input style="font-size: 9pt;" name="numberOverhead_motion[]" type="text" class="numberOverhead_motion_2 form-control input-block" disabled  value="<?php if(isset($value['numberOverhead_motion'])) echo($value['numberOverhead_motion']); ?>"></td>
                            <td><input style="font-size: 9pt;" name="dateOverhead_motion[]" type="text" class="dateOverhead_motion_2 form-control input-block date_order_id" autocomplete="off" disabled value="<?php if($value['dateOverhead_motion'] == NULL || $value['dateOverhead_motion'] == '1970-01-01'  || $value['dateOverhead_motion'] == '0000-00-00') { echo('-');  } else { echo(date('d-m-Y', strtotime($value['dateOverhead_motion']))); }?>"></td>
                            <td><textarea style="width:100%; height:30px; font-size: 9pt;" name="note_motion[]" class="form-control note_motion_2" disabled><?php if(isset($value['note_motion'])) echo($value['note_motion']); ?></textarea></td>
                            <!--Информация заполняемая участками-->
                            <td><input style="font-size: 9pt;" name="dateArrival_motion[]" type="text" class="dateArrival_motion_2 form-control date_order_id" disabled autocomplete="off" value="<?php if($value['dateArrival_motion'] == NULL || $value['dateArrival_motion'] == '1970-01-01' || $value['dateArrival_motion'] == '0000-00-00') { echo('-');  } else { echo(date('d-m-Y', strtotime($value['dateArrival_motion']))); }?>"></td>
                            <td>
                                <input style="font-size: 9pt;"
                                       name="numberM15_motion[]"
                                       type="text"
                                       class="numberM15_motion_2 form-control input-block"
                                       disabled
                                       value="<?php if(isset($value['numberM15_motion'])) echo(date('d-m-Y', strtotime($value['numberM15_motion'])));?>"
                                >
                            </td>
                            <td>
                                <input style="font-size: 9pt;"
                                       name="dateM15_motion[]"
                                       type="text"
                                       class="dateM15_motion_2 form-control input-block date_order_id"
                                       disabled
                                       autocomplete="off"
                                       value="<?php if($value['dateM15_motion'] == NULL || $value['dateM15_motion'] == '1970-01-01') { echo('-');  } else { echo(date('d-m-Y', strtotime($value['dateM15_motion']))); }?> "
                                >
                            </td>
                            <td><input style="font-size: 9pt;" name="dateFilial_motion[]" type="text" class="dateFilial_motion_2 form-control date_order_id" disabled autocomplete="off" value="<?php if($value['dateFilial_motion'] == NULL || $value['dateFilial_motion'] == '1970-01-01') { echo('-');  } else { echo(date('d-m-Y', strtotime($value['dateFilial_motion']))); }?>"></td>
...
<!--                                <a href="#" class="number_table" data-number_table="--><?php //echo($n); ?><!--" onclick="addrowR(this);" >Добавить</a>-->
                            </td>
                        </tr>
                        <?php } elseif ( (($value['id_bond_order_mtr']) == ($item['id_order'])) ) { ?>
                            <tr>
                                <td><input style="font-size: 9pt;" name="length_motion[]" type="text" class="length_motion form-control input-block" disabled value="<?php if(isset($value['length_motion'])) echo($value['length_motion']); ?>"></td>
                                ...
                                <td><input style="font-size: 9pt;" name="tranzit_motion[]" type="text" class="tranzit_motion form-control input-block" disabled value="<?php if(isset($value['tranzit_motion'])) echo($value['tranzit_motion']); ?>"></td>
                                ...
                                <td><input style="font-size: 9pt;" name="numberM15_motion[]" type="text" class="numberM15_motion form-control input-block" disabled value="<?php if(isset($value['numberM15_motion'])) echo($value['numberM15_motion']); ?>"></td>
                                <td><input style="font-size: 9pt;" name="dateM15_motion[]" type="text" class="dateM15_motion form-control input-block date_order_id" disabled autocomplete="off" value="<?php if($value['dateM15_motion'] == NULL || $value['dateM15_motion'] == '0000-00-00' || $value['dateM15_motion'] == '1970-01-01') { echo('-');  } else { echo(date('d-m-Y', strtotime($value['dateM15_motion']))); }?> "></td>
                                ...
                                <td><input style="font-size: 9pt;"
                                    ...
                                    ></td>
                                <td class="ButtonAction">
                                    <a href="#" id="deleterow" onclick="deleteRowTable(this);" data-id-row-tablemtr="<?php if(isset($value['id_motion'])) echo($value['id_motion']); ?>" >Удалить</a>
                                </td>
                            </tr>
                        <?php } endforeach; ?>
